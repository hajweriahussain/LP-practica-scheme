...
public interface schemeListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code expressioBasiques}
	 * labeled alternative in {@link schemeParser#expressionsBasiques}.
	 * @param ctx the parse tree
	 */
	void enterExpressioBasiques(schemeParser.ExpressioBasiquesContext ctx);
	/**
	 * Exit a parse tree produced by the {@code expressioBasiques}
	 * labeled alternative in {@link schemeParser#expressionsBasiques}.
	 * @param ctx the parse tree
	 */
	void exitExpressioBasiques(schemeParser.ExpressioBasiquesContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link schemeParser#expressio}.
	 * @param ctx the parse tree
	 */
	void enterExpressio(schemeParser.ExpressioContext ctx);
	/**
	 * Exit a parse tree produced by {@link schemeParser#expressio}.
	 * @param ctx the parse tree
	 */
